    ...
    <div class="row g-3">
            ...
            <div class="col-md-4">
                <div class="col-sector" data-sector-id="<?= (int)$s['id'] ?>">
                    <div class="sector-header">
                        ...
                        <div class="capacity">Max: <?= (int)$s['max_leerlingen']===0?'∞':(int)$s['max_leerlingen'] ?></div>
                    </div>
        ...
        <div class="col-md-4">
            <div class="col-sector" data-sector-id="0">
                <div class="sector-header"><strong>Niet toegewezen</strong><div class="capacity">—</div></div>
                <div class="dropzone" data-sector-id="0" style="min-height:120px"></div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-3 mt-2" id="studentsPool">
                <?php foreach($leerlingen as $l):
                    ...
                    <div class="col-md-3 student-wrapper" data-leerling-id="<?= $lid ?>" data-assigned="<?= $assigned ?>">
                        <div class="student-item" draggable="true" data-leerling-id="<?= $lid ?>"><?= e($stuNames[$lid]) ?></div>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
...
<script>
    (function(){
        ...
        // Plaats leerlingen in juiste dropzone op basis van toegewezen_voorkeur
        students.forEach(sw=>{
        ...
        document.addEventListener('dragstart', e=>{
            ...
            try { e.dataTransfer.setData('text/plain', sw.getAttribute('data-leerling-id')); } catch {}
        });
        ...
        document.getElementById('btnAuto').addEventListener('click', function(){
            ...
            fetch(window.location.pathname+'?klas_id=<?= $klas_id ?>&action=auto', {method:'POST', headers:{'Accept':'application/json'}})
            ...
            }).catch(err=>{ console.error(err); alert('Fout bij automatisch verdelen'); });
        });
        ...
        document.getElementById('btnSave').addEventListener('click', function(){
            ...
            fetch(window.location.pathname+'?klas_id=<?= $klas_id ?>&action=save',{
                ...
                if(j.success){ alert('Verdeling succesvol opgeslagen.'); location.reload(); }
